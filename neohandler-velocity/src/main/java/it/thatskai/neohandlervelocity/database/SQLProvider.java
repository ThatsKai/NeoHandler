package it.thatskai.neohandlervelocity.database;

import it.thatskai.neohandlervelocity.NeoHandlerVelocity;
import it.thatskai.neohandlervelocity.database.tables.LogsTable;
    ...
    public boolean connect(){
        try {
            ...
            try {
                ...
                NeoHandlerVelocity.getInstance().getLogger().error("Cannot find driver class "+driver);
                return false;
            }
